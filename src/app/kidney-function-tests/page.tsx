...
import { Beaker, Droplet, Microscope, Monitor, Stethoscope, TestTube, Thermometer, User, FileText, BarChart, Dna, Heart, Activity, Wind, Bone, Droplets, LineChart, Scale } from 'lucide-react';

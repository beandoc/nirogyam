...
const FaqItem = ({ question, answer, value }: { question: string, answer: string, value: string }) => {
  return (
    <AccordionItem value={value}>
        ...
        <AccordionContent className="text-gray-700 mt-2 pl-4 text-base">
            {answer}
        </AccordionContent>
    </AccordionItem>
  );
...
const Quiz = () => {
    ...
    return (
        <Card className="max-w-xl mx-auto p-2 sm:p-8">
                ...
                {questions.map((q, index) => (
                    <div key={index} className={cn({ 'hidden': currentQuestion !== index })}>
                        ...
                        <div className="space-y-2">
                           ...
                           {index < 3 && <label className="flex items-center text-gray-700 cursor-pointer">
...
export default function NirogyamPage() {
    ...
    return (
        <div className="bg-background text-foreground">
            <header className="bg-card/80 backdrop-blur-sm shadow-sm sticky top-0 z-50">
                <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-2xl font-bold text-primary ml-2">Nirogyam</h1>
                    </div>
            ...
            <main>
                <section className="hero-pattern py-20 md:py-32 text-center">
                    <div className="container mx-auto px-4">
                        <h2 className="text-4xl md:text-5xl font-bold text-primary leading-tight mb-4">Empowering You with Kidney Health Education</h2>
                        <p className="text-lg md:text-xl text-foreground/80 mb-8 max-w-2xl mx-auto">Your comprehensive resource for understanding kidney health, managing kidney disease, and finding support.</p>
                        <Button size="lg" asChild>
                            <a href="#how-can-we-help">Learn More</a>
                        </Button>
                    </div>
                </section>

                <section id="how-can-we-help" className="py-16 md:py-24 bg-card text-center">
                    <div className="container mx-auto px-4">
                        <h3 className="text-3xl font-bold text-primary mb-6">How Can We Help?</h3>
                ...
                <section id="iam-a-section" className="py-16 md:py-24 bg-background">
                    <div className="container mx-auto px-4 text-center">
                        <h3 className="text-3xl font-bold text-primary mb-10">I am a...</h3>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <Card className="hover:shadow-primary/20 hover:shadow-lg transition-shadow duration-300">
                                <CardHeader><CardTitle className="text-primary text-xl">Patient</CardTitle></CardHeader>
                                <CardContent>
                                    <ul className="text-foreground/80 text-left pl-4 list-disc space-y-2">
                                        <li><a href="#kidney-topic" className="hover:underline text-primary">Kidney Topics</a></li>
                                        <li><a href="#renal-nutrition" className="hover:underline text-primary">Diet & Nutrition</a></li>
                                        <li><a href="#assess-kidney" className="hover:underline text-primary">Know Your Risk Quiz</a></li>
                                        <li><a href="#transplant-surgery" className="hover:underline text-primary">Kidney Transplantation</a></li>
                                    </ul>
                                </CardContent>
                            </Card>
                            <Card className="hover:shadow-primary/20 hover:shadow-lg transition-shadow duration-300">
                                <CardHeader><CardTitle className="text-primary text-xl">Health Professional</CardTitle></CardHeader>
                                <CardContent>
                                    <ul className="text-foreground/80 text-left pl-4 list-disc space-y-2">
                                        <li><a href="#clinical-resources" className="hover:underline text-primary">Clinical Resources</a></li>
                                        <li><a href="#latest-research" className="hover:underline text-primary">Latest Research</a></li>
                                        <li><a href="#treatment-guidelines" className="hover:underline text-primary">Treatment Guidelines</a></li>
                                        <li><a href="#nutrition-recommendations" className="hover:underline text-primary">Nutrition Recommendations</a></li>
                                    </ul>
                                </CardContent>
                            </Card>
                            <Card className="hover:shadow-primary/20 hover:shadow-lg transition-shadow duration-300">
                                <CardHeader><CardTitle className="text-primary text-xl">Caregiver</CardTitle></CardHeader>
                                <CardContent>
                                    <ul className="text-foreground/80 text-left pl-4 list-disc space-y-2">
                                        <li><a href="#support-resources" className="hover:underline text-primary">Support Resources</a></li>
                                        <li><a href="#diet-planning" className="hover:underline text-primary">Diet Planning</a></li>
                                        <li><a href="#treatment-preparation" className="hover:underline text-primary">Treatment Preparation</a></li>
                                        <li><a href="#post-treatment-care" className="hover:underline text-primary">Post-Treatment Care</a></li>
                                    </ul>
                                </CardContent>
                            </Card>
                        </div>
                 ...
                 <section id="kidney-topic" className="py-16 md:py-24 bg-card">
                    <div className="container mx-auto px-4">
                        <h3 className="text-3xl font-bold text-primary text-center mb-4">Kidney Topics</h3>
                        <p className="text-lg text-foreground/80 text-center mb-12">This section provides a deeper dive into common and relevant topics for understanding kidney health.</p>
                ...
                <section id="assess-kidney" className="py-16 md:py-24 bg-background">
                    <div className="container mx-auto px-4">
                        <h3 className="text-3xl font-bold text-primary text-center mb-4">Assess Your Kidney Health</h3>
                        <p className="text-lg text-foreground/80 text-center mb-12 max-w-2xl mx-auto">Take our quick assessment to understand your risk factors. Early detection can help prevent or slow the progression of kidney disease.</p>
                        <Quiz />
                    </div>
                </section>

                <section id="renal-nutrition" className="py-16 md:py-24 bg-card">
                    <div className="container mx-auto px-4">
                        <h3 className="text-3xl font-bold text-primary text-center mb-4">Renal Nutrition</h3>
                         <p className="text-lg text-foreground/80 text-center mb-12 max-w-2xl mx-auto">Proper nutrition is crucial for managing kidney health. Explore our resources on dietary guidelines for various stages of kidney disease.</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                           <Card>
                             <Image src="https://placehold.co/600x400.png" alt="Healthy food" width={600} height={400} className="rounded-t-lg" data-ai-hint="healthy food" />
                             <CardHeader><CardTitle>Diet for Early Stages</CardTitle></CardHeader>
                             <CardContent><p className="text-foreground/80">Learn about the best foods to support kidney function in early stages of CKD.</p></CardContent>
                           </Card>
                           <Card>
                             <Image src="https://placehold.co/600x400.png" alt="Low potassium foods" width={600} height={400} className="rounded-t-lg" data-ai-hint="low potassium food" />
                           ...
                           <Card>
                              <Image src="https://placehold.co/600x400.png" alt="Low phosphorus foods" width={600} height={400} className="rounded-t-lg" data-ai-hint="low phosphorus food" />
                             <CardHeader><CardTitle>Controlling Phosphorus</CardTitle></CardHeader>
                             <CardContent><p className="text-foreground/80">Understand phosphorus restrictions and smart food choices for your health.</p></CardContent>
                           </Card>
                        </div>
                    </div>
                </section>
                
                 <section id="kidney-conversations" className="py-16 md:py-24 bg-background">
                    <div className="container mx-auto px-4 text-center">
                        <h3 className="text-3xl font-bold text-primary mb-4">Kidney Conversations</h3>
                        <p className="text-lg text-foreground/80 mb-12 max-w-2xl mx-auto">Tune into our podcasts for in-depth discussions with experts, patient stories, and the latest advancements in kidney care.</p>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <Card>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <p className="text-foreground/80 mb-4">Inspiring journeys and experiences from individuals living with kidney disease.</p>
                                    <audio controls className="w-full">
                        ...
                        <div className="mt-10">
                             <Button size="lg">Explore More Podcasts</Button>
                        </div>
                    </div>
                </section>
                ...
                <section id="services" className="py-16 md:py-24 bg-card">
                    <div className="container mx-auto px-4 text-center">
                        <h3 className="text-3xl font-bold text-primary mb-12">Our Services</h3>
                ...
                <section id="faq" className="py-16 md:py-24 bg-card">
                    <div className="container mx-auto px-4">
                        <h3 className="text-3xl font-bold text-primary text-center mb-10">Frequently Asked Questions</h3>
                ...
                <section id="about" className="py-16 md:py-24 bg-background">
                    <div className="container mx-auto px-4 text-center">
                         <div className="mx-auto bg-primary/10 rounded-full h-20 w-20 flex items-center justify-center mb-6">
                            <Users className="h-10 w-10 text-primary" />
                        </div>
                        <h3 className="text-3xl font-bold text-primary mb-6">About Nirogyam</h3>
                        <p className="text-lg text-foreground/80 max-w-3xl mx-auto">Nirogyam is dedicated to providing clear, reliable, and accessible information on kidney health. We believe that informed patients and caregivers are empowered to make the best decisions for their health journey. Our content is curated by medical professionals and patient advocates to ensure accuracy and relevance.</p>
                    </div>
                </section>

                <section id="contact" className="py-16 md:py-24 bg-card">
                    <div className="container mx-auto px-4 text-center">
                        <h3 className="text-3xl font-bold text-primary mb-4">Contact Us</h3>
                        <p className="text-lg text-foreground/80 mb-12 max-w-2xl mx-auto">Have questions or need support? Reach out to us!</p>
